var privacyPolicy2 = `<button type="button" id="btnPP" class="btn tbn-primary" onclick="viewPP">Privacy Policy</button>
<h2 style="text-align: center;"><b>PRIVACY POLICY</b></h2>
<p>Effective date: 2022-06-01</p>
<p>1. <b>Introduction</b></p>
<p>Welcome to <b> "XXXX"</b>.</p>
<p><b>XXXX</b> (“us”, “we”, or “our”) operates <b>XXXX.co</b> (hereinafter referred to as <b>“Service”</b>).</p>
<p>Our Privacy Policy governs your visit to <b>XXXX.co</b>, and explains how we collect, safeguard and disclose information that results from your use of our Application.</p>
<p>We use only your Google email address to control the access to the Application. By using the Application, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions.</p>
...
<p><b>APPLICATION</b> means the XXXX.co Applications(s) website operated by XXXX.</p>
...
<p>We only collect you current Google email Address to control the access to the application, and avoid others can use your email to use it.</p>
...
<p>* Only the email address is collected automatically. Othger personal data is captured to process the payments in PayPal and we do not save any personal data.</p>
<p>We won't use your Personal Data to contact you with newsletters, marketing or promotional materials and other unsolicited information.</p>
<p><b>Usage Data</b></p>
<!--part 1-->
<p><b>We do not collect usage data of your Appllication in our side; any data generated by you is saved locally in your device.</b>).</p>

<p><b>Tracking Cookies Data</b></p>
<p>As the Application runs inside a browser, we don't use Cookies in any way, only if they are used by the browser.</p>
...
<p>As we don't use cookies, we only use LocalStorage to save configuration information.  The Local Storage is a n internal repository assigned to every site in the browser, and can be deleted by the user.</p>

<p>5. <b>Use of Data</b></p>
<p>XXXX uses the collected data for various purposes:</p>
<p>0.1. to provide and maintain our Service and control the access to the Application;</p>
...
<p>XXXX will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
<!--part2-->
...
<p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>kryptiguy@gmail.com</b>.</p>
...
<p>0.4. users are able to change their personal information by emailing us at <b>kryptiguy@gmail.com</b>.</p>
<p>*You can access our Application anonymously, but you won't have access to the premium features, only the free ones.</p>
...
<p>To exercise your California data protection rights described above, please send your request(s) by email: <b>kryptiguy@gmail.com</b>.</p>
...
<p>We may use third-party Service Providers to monitor and analyze the use of our Application.</p>
<p>15. <b>CI/CD tools</b></p>
<p>We may use third-party Service Providers to automate the development process of our Application.</p>
...
<p>If you have any questions about this Privacy Policy, please contact us by email: <b>kryptiguy@gmail.com</b>.</p>
<p style="margin-top: 5em; font-size: 0.7em;">This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was created for <b>XXXX.co</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-06-01.</p>
`;

function getPrivacyPolicy2Text(divId, textId, successMessage, lang)
{
  privacyPolicy2 = getText(privacyPolicy2,lang);
  return {"div": divId, "id": textId, "message": successMessage, "text": privacyPolicy2};
}